      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
          ...
          <div ref={cardRef} className="lg:w-[48%] relative group">
            <div className="absolute inset-x-4 -bottom-4 h-full bg-[#111827]/5 blur-3xl rounded-[3rem] -z-10 group-hover:bg-[#111827]/10 transition-colors" />

            <div className="bg-[#4C1D95] rounded-[1.25rem] lg:rounded-[1.5rem] overflow-hidden shadow-[12px_25px_50px_-15px_rgba(76,29,149,0.12)] border border-[#5B21B6]/15">

              {/* Card Header (Purple - Ultra Compact) */}
              <div className="px-6 py-4 lg:py-4.5 flex items-center gap-3.5 border-b border-white/10">
