               ...
               <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
                  ...
                  <div className="lg:col-span-8 space-y-8">
                     <div className="space-y-4">
                        ...
                        <div className="space-y-4">
                           ...
                           <p className="text-sm lg:text-base text-slate-600 font-semibold leading-relaxed">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-100">
                        <div className="space-y-2">
                           <h3 className="text-sm font-extrabold text-slate-900 uppercase tracking-widest">Benefits & Utility</h3>
                        ...
                        <div className="space-y-2">
                           <h3 className="text-sm font-extrabold text-slate-900 uppercase tracking-widest">Business Impact</h3>
                        ...
                        {[
                           ...
                           <div key={i} className="group p-5 rounded-md bg-white border border-slate-100 shadow-sm transition-all hover:border-[#FF6600] space-y-3">
                              <div className="flex items-center gap-4">
                                 ...
                                 <h3 className="text-sm lg:text-base font-display font-extrabold text-slate-900 uppercase tracking-tight leading-none group-hover:text-[#FF6600] transition-colors duration-500">{pillar.title}</h3>
                              </div>
                  ...
                  <div className="lg:col-span-4 lg:sticky lg:top-28 space-y-6">
                     <div className="p-6 rounded-md bg-white border border-slate-100 shadow-xl space-y-4">
                        <h3 className="text-[11px] lg:text-[13px] font-extrabold text-[#FF6600] uppercase tracking-[0.3em] flex items-center gap-2">
                     ...
                     <div className="p-6 rounded-md bg-slate-900 text-white space-y-4">
                        <h3 className="text-[11px] lg:text-[13px] font-extrabold text-[#FF6600] uppercase tracking-[0.3em]">Conversion Targets</h3>
