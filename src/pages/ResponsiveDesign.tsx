...
export default function ResponsivePage() {
   ...
   return (
      <div className="pt-[80px] bg-white min-h-screen font-secondary">
         ...
         <section className="max-w-[1400px] mx-auto px-8 lg:px-20 py-8 relative z-20 border-t border-slate-50">
            <div className="grid grid-cols-1 lg:grid-cols-[1.35fr_0.65fr] gap-10 lg:gap-14 items-start">
               ...
               <div className="space-y-10">
                  ...
                  <div className="space-y-4">
                     <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#FF6600] flex items-center gap-3">
                        <div className="w-6 h-[1px] bg-[#FF6600]/20" /> Responsive Mobile Website
                     </span>
                     <div className="space-y-4 text-slate-500 text-base lg:text-lg font-semibold leading-relaxed max-w-3xl">
                        <p>
                  ...
                  <div className="space-y-4">
                     <h3 className="text-xl lg:text-2xl font-display font-bold text-slate-900 tracking-tight">How Can we Make Responsive Web Design For Your Business</h3>
                     <p className="text-slate-500 text-base lg:text-lg font-semibold leading-relaxed italic border-l-2 border-[#FF6600] pl-4">
                        ...
                        >
                           ...
                           <div className="relative z-10 space-y-3">
                              ...
                              <div className="flex items-center gap-3">
                                 ...
                                 <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#FF6600]">{card.t}</span>
                              </div>
                              ...
                              <div className="space-y-1">
                                 ...
                                 <p className="text-sm lg:text-base font-semibold text-slate-500 leading-relaxed group-hover:text-slate-700 transition-colors duration-500 max-w-sm">
                                    {card.p}
                                 </p>
                              </div>
