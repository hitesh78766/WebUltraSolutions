        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-[16px] lg:text-[20px] font-bold capitalize tracking-wider leading-[0.9]">{pillar.title}</h3>
                    </div>
                  </div>
                  <p className="text-[13px] md:text-sm lg:text-base font-semibold leading-relaxed text-slate-500 group-hover:text-slate-700 transition-colors">
                    {pillar.desc}
                  </p>
                </div>
              </motion.div>
          ...
          <div className="lg:col-span-12 py-12 flex flex-col items-center gap-12 border-y border-slate-50">
            <div className="text-center space-y-2">
              <h2 className="text-lg md:text-xl lg:text-2xl font-display font-bold tracking-tight uppercase text-slate-950">Interactive <span className="text-[#FF6600]">Lifecycle.</span></h2>
              <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#FF6600]">Proprietary Project Orchestration Diagram</p>
            </div>
            ...
            <div className="relative w-full max-w-4xl">
              ...
              <div className="lg:hidden flex flex-col items-center gap-6 py-8">
                ...
                <motion.div
                  ...
                  className="relative z-20 w-24 h-24 md:w-28 md:h-28 rounded-full bg-slate-900 border-4 border-[#FF6600] flex items-center justify-center shadow-[0_0_30px_rgba(255,102,0,0.2)]"
                >
                  <span className="text-white font-display font-black text-xs tracking-widest uppercase">Project</span>
                  <div className="absolute -inset-3 border border-[#FF6600]/30 rounded-full animate-spin-slow" />
                </motion.div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full max-w-md">
                  {lifecycleSteps.map((step, i) => (
                    <motion.div
                      ...
                      className="px-3 py-2 bg-white border border-slate-100 rounded-md shadow-lg flex items-center gap-2 group cursor-pointer hover:border-[#FF6600] transition-colors"
                    >
                      <div className="w-1.5 h-1.5 rounded-full bg-[#FF6600]" />
                      <span className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-900">{step}</span>
              ...
              <div className="hidden lg:flex relative w-full h-[400px] items-center justify-center">
                ...
                <motion.div
                  ...
                  transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
                  className="relative z-20 w-40 h-40 rounded-full bg-slate-900 border-4 border-[#FF6600] flex items-center justify-center shadow-[0_0_50px_rgba(255,102,0,0.2)]"
                >
                  <span className="text-white font-display font-black text-sm tracking-widest uppercase">Project</span>
                ...
                {lifecycleSteps.map((step, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      transition={{ delay: i * 0.1, duration: 0.5 }}
                      style={{ x, y }}
                      className="absolute z-10 px-6 py-2 bg-white border border-slate-100 rounded-md shadow-xl flex items-center gap-3 group cursor-pointer hover:border-[#FF6600] transition-colors"
                    >
                      <div className="w-1.5 h-1.5 rounded-full bg-[#FF6600]" />
