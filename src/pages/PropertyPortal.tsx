         ...
         <div className="relative min-h-[350px] lg:min-h-[450px] bg-transparent flex items-center justify-center overflow-hidden border-b border-orange-100/50">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 text-center space-y-6 lg:space-y-8">
               <div className="flex flex-col items-center gap-4">
                  ...
                  <h1 className="text-4xl lg:text-6xl font-display font-extrabold text-slate-900 tracking-tight leading-[1] uppercase max-w-5xl mx-auto">
                     {(() => {
               ...
               <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
                  ...
                  <div className="lg:col-span-8 space-y-16">
                     <div className="space-y-10">
                        ...
                        <div className="space-y-10">
                           <h2 className="text-3xl lg:text-5xl font-display font-extrabold text-slate-950 tracking-tight uppercase leading-[0.9]">
                           ...
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                              <div className="space-y-6">
                                 <p className="text-base lg:text-lg font-semibold text-slate-900 leading-relaxed tracking-tight border-l-4 border-[#FF6600] pl-8 py-2">
                     ...
                     <div className="pt-12 space-y-10">
                        <div className="flex items-center gap-4">
                           ...
                           <h3 className="text-[12px] font-bold text-slate-950 uppercase tracking-[0.3em]">Operational Pillars</h3>
                        </div>
                              ...
                              >
                                 ...
                                 <div className="space-y-3 relative z-10">
                                    <div className="flex flex-col">
                                       <span className="text-[10px] font-bold text-[#FF6600] uppercase tracking-widest leading-none mb-1">{pillar.tag}</span>
                                       <h4 className="text-xl font-display font-extrabold text-slate-950 transition-colors uppercase tracking-tight">
                                          {pillar.title}
                                       </h4>
                                    </div>
                                    <p className="text-xs lg:text-sm font-semibold leading-relaxed text-slate-500 group-hover:text-slate-700 transition-colors">
                                       {pillar.desc}
                                    </p>
                                 </div>
                     ...
                     <div className="p-10 rounded-2xl bg-white border border-slate-100 shadow-[0_40px_80px_rgba(0,0,0,0.08)] space-y-10 relative overflow-hidden group/card">
                        ...
                        <div className="relative z-10 space-y-10">
                           <div className="flex items-center gap-3 pb-5 border-b border-slate-100">
                              ...
                              <h4 className="text-[14px] font-display font-extrabold text-slate-950 uppercase tracking-[0.2em]">Platform Specs</h4>
                           </div>
                           ...
                           <div className="pt-10 border-t border-slate-100 space-y-6">
                              ...
                              <button className="w-full py-5 bg-[#FF6600] text-white text-[11px] font-black uppercase tracking-[0.3em] rounded-lg shadow-2xl shadow-orange-200 hover:bg-slate-950 hover:shadow-slate-200 transition-all duration-500 flex items-center justify-center gap-3 group/btn">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                  ...
                  >
                     <div className="space-y-4">
                        <h3 className="text-2xl font-extrabold text-slate-950 uppercase tracking-tighter">Visual <br /> Archetypes.</h3>
                     ...
                     <div className="h-[600px] rounded-2xl overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] group relative cursor-crosshair">
                        ...
                        <div className="absolute top-6 right-6">
                           <div className="px-3 py-1.5 rounded-md bg-white text-[#FF6600] shadow-xl flex items-center gap-2 border border-orange-100">
                              ...
                              <span className="text-[10px] font-extrabold uppercase tracking-wider">High Fidelity</span>
                           </div>
                        </div>
                        <div className="absolute inset-x-0 bottom-0 p-8 bg-gradient-to-t from-black/80 to-transparent">
                           <span className="text-[10px] font-extrabold text-orange-500 uppercase tracking-widest">Metadata Integration</span>
                           <h4 className="text-xl font-extrabold text-white uppercase tracking-tight">High-Fidelity Listings</h4>
                        </div>
                     </div>
                  </motion.div>
                  ...
                  >
                     <div className="h-[400px] rounded-2xl overflow-hidden shadow-2xl group cursor-crosshair relative">
                        ...
                        <div className="absolute top-6 right-6">
                           <div className="px-3 py-1.5 rounded-md bg-[#FF6600] text-white shadow-xl flex items-center gap-2">
                              <div className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
                              <span className="text-[10px] font-extrabold uppercase tracking-wider">Validated Logic</span>
                           </div>
                        </div>
                     </div>
                     <div className="p-8 bg-white rounded-2xl border border-slate-100 shadow-sm group hover:border-orange-200 transition-colors">
                        <CheckCircle2 size={32} className="text-[#FF6600] mb-4" />
                        <h4 className="text-lg font-extrabold text-slate-950 uppercase tracking-tight mb-2">Validated Logic</h4>
