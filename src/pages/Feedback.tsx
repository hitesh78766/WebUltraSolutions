              ...
              {reviews.map((review, i) => (
                ...
                >
                  ...
                  <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-10 transition-opacity">
                    <Quote size={60} className="text-[#FF6600] rotate-12" />
                  </div>
                  ...
                  <div className="space-y-5 relative z-10 pt-4">
                    ...
                    <p className="text-[14px] lg:text-[15px] text-slate-700 font-semibold leading-relaxed group-hover:text-slate-950 transition-colors">
                      "{review.text}"
                    </p>
                  </div>
                  ...
                  <div className="pt-6 border-t border-slate-50 flex items-center justify-between">
                    <div className="space-y-1">
                      <h4 className="text-[13px] font-bold text-slate-950 uppercase tracking-tighter leading-none">{review.name}</h4>
                      <p className="text-[11px] font-bold text-[#FF6600] capitalize tracking-tight leading-none">{review.role}</p>
                    </div>
                    <div className="w-10 h-10 rounded-sm bg-orange-50 border border-orange-100 flex items-center justify-center text-[#FF6600] shadow-sm transform group-hover:bg-[#FF6600] group-hover:text-white transition-all group-hover:rotate-[360deg] duration-700">
                      <ShieldCheck size={20} />
                    </div>
                  </div>
                </motion.div>
