...
export default function GraphicPage() {
   ...
   return (
      <div className="pt-[80px] bg-white min-h-screen font-secondary overflow-x-hidden">
         ...
         <section className="py-6 md:py-8 bg-white flex items-center overflow-hidden border-t border-slate-50">
            <div className="max-w-[1400px] mx-auto px-4 md:px-8 lg:px-24">
               ...
               <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
                  ...
                  <div className="lg:col-span-12 space-y-6">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-14">
                        ...
                        <div className="space-y-4">
                           ...
                           <div className="pl-4 border-l-2 border-orange-50">
                              <p className="text-[10px] md:text-[11px] font-medium text-slate-600 leading-relaxed italic">
                     ...
                     <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 lg:gap-5">
                        {[
                           ...
                           <motion.div
                              ...
                              className="group relative p-3 md:p-4 rounded-md bg-white border border-slate-100 hover:border-[#FF6600]/30 shadow-sm hover:shadow-[0_15px_40px_rgba(255,102,0,0.08)] transition-all duration-500 cursor-pointer overflow-hidden"
                           >
                              {/* FLOATING INDEX ACCENT */}
                              <div className="absolute top-0 right-0 p-2 opacity-5 group-hover:opacity-10 transition-opacity">
                                 <span className="text-2xl md:text-3xl font-display font-bold text-slate-900 select-none italic tracking-tighter">
                                    {(i + 1).toString().padStart(2, '0')}
                                 </span>
                              </div>

                              <div className="relative z-10 space-y-2">
                                 <div className="w-7 h-7 md:w-8 md:h-8 rounded-md bg-orange-50 flex items-center justify-center text-[#FF6600] group-hover:bg-[#FF6600] group-hover:text-white transition-all duration-500 shadow-sm">
                                    <item.i className="w-3.5 h-3.5 md:w-4 md:h-4" />
                                 </div>
                                 <div className="space-y-0.5">
                                    <h4 className="text-[13px] md:text-sm lg:text-base font-display font-bold text-slate-950 group-hover:text-[#FF6600] transition-colors duration-500 tracking-tight leading-tight">
                                       {item.t}
                                    </h4>
                                    <div className="w-4 h-0.5 bg-slate-100 group-hover:w-12 group-hover:bg-[#FF6600] transition-all duration-700" />
                                 </div>
                              </div>
                           </motion.div>
                        ))}
